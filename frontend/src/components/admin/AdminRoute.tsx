 ...
 *  - If not authenticated OR not admin → redirect immediately to Home Page ("/")
 *  - If admin → allow child route access
 */
    ...
    return (
      <div className="admin-route-loading" style={{ display: 'flex', height: '100vh', alignItems: 'center', justifyContent: 'center', background: '#090d16', color: '#94a3b8' }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={{ fontWeight: 600 }}>Verifying Admin Credentials…</p>
        </div>
      </div>
    );
  }
