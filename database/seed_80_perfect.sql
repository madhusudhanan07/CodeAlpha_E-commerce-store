...
INSERT INTO `products` (`id`, `category_id`, `name`, `slug`, `description`, `image_url`, `price`, `stock`, `is_featured`, `brand`, `discount_percentage`, `rating`, `review_count`) VALUES
  ...
  (28, 4, 'KitchenAid Stand Mixer', 'kitchenaid-mixer', 'Artisan series 5-quart tilt-head mixer.', 'https://images.unsplash.com/photo-1589578228447-e1a4e481c6c8?w=600&h=600&fit=crop', 429.99, 30, 1, 'KitchenAid', 0.0, 4.9, 520),
